...
class RSComm(BaseComm):
    ...
    def _build_runtime(self, topo_key):
        c = self.config
        return pace_cpp.RSComm(self.rank, self.num_ranks, self.num_local_ranks, c.slot_unroll, c.nvl_ring_size, c.rdma_ring_size, c.num_sms, c.ultra_node_scope, c.use_wg, topo_key)
