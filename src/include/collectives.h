...
#define ALLREDUCE_SLICE_PER_CHUNK 2
#define ALLREDUCE_CHUNKSTEPS (ALLREDUCE_SLICESTEPS * ALLREDUCE_SLICE_PER_CHUNK)

#define ALLGATHER_SLICESTEPS 2
#define ALLGATHER_SLICE_PER_CHUNK 2
#define ALLGATHER_CHUNKSTEPS (ALLGATHER_SLICESTEPS * ALLGATHER_SLICE_PER_CHUNK)

#define REDUCESCATTER_SLICESTEPS 2
#define REDUCESCATTER_SLICE_PER_CHUNK 2
#define REDUCESCATTER_CHUNKSTEPS (REDUCESCATTER_SLICESTEPS * REDUCESCATTER_SLICE_PER_CHUNK)
