...
typedef struct {
  ...
  // new in v13 to update QoS parameters for a specific context (unified for both GDAKI and IbProxy)
  ncclResult_t (*updateContextQosParams)(void* collComm, const int contextIndex, const int trafficClass);
