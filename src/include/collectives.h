...
#define BROADCAST_SLICESTEPS DEFAULT_SLICESTEPS
#define BROADCAST_CHUNKSTEPS DEFAULT_CHUNKSTEPS
#define REDUCE_SLICESTEPS DEFAULT_SLICESTEPS
#define REDUCE_CHUNKSTEPS DEFAULT_CHUNKSTEPS
