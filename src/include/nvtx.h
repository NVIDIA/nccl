...
// @EUGO_CHANGE:
// nccl-vendored version of nvtx3 includes this header in "nvtx3/nvtx3.hpp" but upstream doesn't.
#include "nvtx3/nvToolsExtPayload.h"

// @begin:EUGO_CHANGE:
// Compatability shim between vendored and modern version
//
// References:
// 1. [unresolved] https://github.com/NVIDIA/nccl/issues/1270
#define NVTX_PAYLOAD_SCHEMA_ATTR_NAME NVTX_PAYLOAD_SCHEMA_ATTR_FIELD_NAME
#define NVTX_PAYLOAD_SCHEMA_ATTR_TYPE NVTX_PAYLOAD_SCHEMA_ATTR_FIELD_TYPE
#define NVTX_PAYLOAD_SCHEMA_ATTR_FLAGS NVTX_PAYLOAD_SCHEMA_ATTR_FIELD_FLAGS
#define NVTX_PAYLOAD_SCHEMA_ATTR_ENTRIES NVTX_PAYLOAD_SCHEMA_ATTR_FIELD_ENTRIES
#define NVTX_PAYLOAD_SCHEMA_ATTR_NUM_ENTRIES NVTX_PAYLOAD_SCHEMA_ATTR_FIELD_NUM_ENTRIES
#define NVTX_PAYLOAD_SCHEMA_ATTR_STATIC_SIZE NVTX_PAYLOAD_SCHEMA_ATTR_FIELD_STATIC_SIZE
#define NVTX_PAYLOAD_SCHEMA_ATTR_ALIGNMENT NVTX_PAYLOAD_SCHEMA_ATTR_FIELD_ALIGNMENT
#define NVTX_PAYLOAD_SCHEMA_ATTR_SCHEMA_ID NVTX_PAYLOAD_SCHEMA_ATTR_FIELD_SCHEMA_ID
#define NVTX_PAYLOAD_SCHEMA_ATTR_EXTENSION NVTX_PAYLOAD_SCHEMA_ATTR_FIELD_EXTENSION


#define NVTX_PAYLOAD_ENUM_ATTR_ENTRIES NVTX_PAYLOAD_ENUM_ATTR_FIELD_ENTRIES
#define NVTX_PAYLOAD_ENUM_ATTR_NUM_ENTRIES NVTX_PAYLOAD_ENUM_ATTR_FIELD_NUM_ENTRIES
#define NVTX_PAYLOAD_ENUM_ATTR_SIZE NVTX_PAYLOAD_ENUM_ATTR_FIELD_SIZE
#define NVTX_PAYLOAD_ENUM_ATTR_SCHEMA_ID NVTX_PAYLOAD_ENUM_ATTR_FIELD_SCHEMA_ID
#define NVTX_PAYLOAD_ENUM_ATTR_NAME NVTX_PAYLOAD_ENUM_ATTR_FIELD_NAME
#define NVTX_PAYLOAD_ENUM_ATTR_EXTENSION NVTX_PAYLOAD_ENUM_ATTR_FIELD_EXTENSION

#define NVTX_PAYLOAD_ENTRY_TYPE_SCHEMA_ID_STATIC_START NVTX_PAYLOAD_SCHEMA_ID_STATIC_START
#define NVTX_PAYLOAD_ENTRY_TYPE_SCHEMA_ID_DYNAMIC_START NVTX_PAYLOAD_SCHEMA_ID_DYNAMIC_START
// @end:EUGO_CHANGE
