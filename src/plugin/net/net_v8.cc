                                           ...
                                           void *sendMhandle, void **request)
{
  ...
  if (nRecvParts > 1)
    return ncclInternalError;
  if (recvParts->size > MAX_COLLNET_SIZE)
    return ncclInternalError;
                                               ...
                                               void *recvMhandle, void **request)
{
  ...
  if (nSendParts > 1)
    return ncclInternalError;
  if (sendParts->size > MAX_COLLNET_SIZE)
    return ncclInternalError;
