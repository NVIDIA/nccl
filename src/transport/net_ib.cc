...
static sa_family_t getGidAddrFamily(union ibv_gid*);
static bool matchGidAddrPrefix(sa_family_t, void*, int, union ibv_gid*);
static bool validGid(union ibv_gid*);
...
static bool configuredGid(union ibv_gid*);
static bool linkLocalGid(union ibv_gid*);
