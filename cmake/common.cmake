...
set(CMAKE_CUDA_FLAGS
    "${CMAKE_CUDA_FLAGS} -Xcuda-ptxas -maxrregcount=96 -Xcuda-fatbinary -compress-all -fPIC -fvisibility=hidden"
)
...
if(VERBOSE)
  set(CMAKE_CUDA_FLAGS
      "${CMAKE_CUDA_FLAGS} -Xcuda-ptxas -v -Wall,-Wextra,-Wno-unused-parameter"
  )
