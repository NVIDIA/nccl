...
*
* \param reserved - must be zero or nullptr.
*
* @{ */
...
*
* nvtxDomainMarkEx(nullptr, event) is equivalent to calling
* nvtxMarkEx(event).
*
...
*
* nvtxDomainNameCategory(nullptr, category, name) is equivalent to calling
...
*
* \param domain  - Domain handle. If nullptr then the global domain is used.
...
* all events are scoped to a global domain where nullptr is provided or when
...
* nvtxDomainMarkEx(nullptr, &eventAttrib1);
*
