...
> Apache-2.0. Treat function names and file paths as reading anchors; they may
...
These notes are source-driven and describe the code that exists in this library
as of NCCL v2.30u1 (2.30.6). NCCL evolves quickly, so treat function names and
file paths here as anchors for reading the code, not as a promise that every
internal detail is stable forever.
