...
function(nccl_detect_installed_gpus out_variable)
set(CUDA_gpu_detect_output "")
  if(NOT CUDA_gpu_detect_output)
    ...
    if(__nvcc_res EQUAL 0)
      ...
      set(CUDA_gpu_detect_output ${__nvcc_out} CACHE INTERNAL "Returned GPU architetures from nccl_detect_gpus tool" FORCE)
    else()
  ...
  if(NOT CUDA_gpu_detect_output)
    message(WARNING "Automatic GPU detection failed. Building for all known architectures (${nccl_known_gpu_archs}).")
    set(${out_variable} ${nccl_known_gpu_archs} PARENT_SCOPE)
  else()
...
# Usage:
#   nccl_select_nvcc_arch_flags(out_variable)
function(nccl_select_nvcc_arch_flags out_variable)
  # List of arch names
  ...
  if(${CUDA_ARCH_NAME} STREQUAL "Manual")
    set(CUDA_ARCH_BIN ${nccl_known_gpu_archs} CACHE STRING "Specify 'real' GPU architectures to build binaries for, BIN(PTX) format is supported")
  ...
  elseif(${CUDA_ARCH_NAME} STREQUAL "All")
    set(__cuda_arch_bin ${nccl_known_gpu_archs})
  elseif(${CUDA_ARCH_NAME} STREQUAL "Auto")
    nccl_detect_installed_gpus(__cuda_arch_bin)
  ...
  nccl_list_unique(__cuda_arch_bin __cuda_arch_ptx)
...
# Usage:
#   nccl_cuda_compile(<objlist_variable> <cuda_files>)
macro(nccl_cuda_compile objlist_variable)
...
list(APPEND nccl_LINKER_LIBS ${CUDA_CUDART_LIBRARY}
                              ${CUDA_curand_LIBRARY} ${CUDA_CUBLAS_LIBRARIES})

# Known NVIDIA GPU achitectures nccl can be compiled for.
# This list will be used for CUDA_ARCH_NAME = All option
if(CUDA_ARCH_ALL)
  set(nccl_known_gpu_archs "${CUDA_ARCH_ALL}")
else()
  if(${CUDA_VERSION} GREATER 7.5)
    set(nccl_known_gpu_archs "30 35 50 52 60 61")
  else()
    set(nccl_known_gpu_archs "30 35 50 52")
  endif()
endif()
...
if(USE_CUDNN)
  ...
  if(HAVE_CUDNN)
    ...
    list(APPEND nccl_LINKER_LIBS ${CUDNN_LIBRARY})
  endif()
endif()

# setting nvcc arch flags
nccl_select_nvcc_arch_flags(NVCC_FLAGS_EXTRA)
...
if(APPLE)
  nccl_detect_darwin_version(OSX_VERSION)
  ...
  if(OSX_VERSION VERSION_GREATER 10.8)
    ...
    nccl_option(USE_libstdcpp "Use libstdc++ instead of libc++" (CUDA_VERSION VERSION_LESS 7.0))
  endif()
endif()
